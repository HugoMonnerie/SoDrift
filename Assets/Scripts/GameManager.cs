...
public class GameManager : Manager<GameManager>
{
	...
	public override void SubscribeEvents()
	{
		...
		EventManager.Instance.AddListener<Map1ButtonClickedEvent>(Map1ButtonClicked);
		EventManager.Instance.AddListener<Map2ButtonClickedEvent>(Map2ButtonClicked);
	...
	public override void UnsubscribeEvents()
	{
		...
		EventManager.Instance.RemoveListener<Map1ButtonClickedEvent>(Map1ButtonClicked);
		EventManager.Instance.RemoveListener<Map2ButtonClickedEvent>(Map2ButtonClicked);
